...
import { deletedListMajors, getAllMajors } from "../../../../service/MajorService";
...
const Major = (props) => {
    ...
    const handleSoftDelete = async () => {
        setSpinning(true);
        const putData = {
            id_major: selectedRowKeys,
        }
        

        try {
            const response = await deletedListMajors(putData);
            setSpinning(false);
            getMajor();
    ...
    const getMajor = async () => {
        ...
        try {
            ...
            const newsMajorsData = response.data.map((Majors) => {
                return {
                    key: Majors.id_major,
                    name_vi: Majors.name_vi,
                    name_en: Majors.name_en,
                    created_at: Majors.created_at,
                    updated_at: Majors.updated_at,
                    action: Majors.id_major,
                };
            });

            setMajorData(newsMajorsData);
        ...
        <div className="HomeAdmin flex flex-col gap-5 items-start">
            ...
            <div className="flex items-start justify-between w-full">
                <Breadcrumbs underline="hover">
                    ...
                    <BreadcrumbItem>Quản lý chuyên ngành</BreadcrumbItem>
                </Breadcrumbs>
