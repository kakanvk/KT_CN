...
const CreateTeacher = (props) => {
    ...
    const Create = async () => {
        ...
        try {
            ...
            setSpinning(false);
            successNoti("Lưu thành  thành công");
        } catch (error) {
            ...
            <div className="CreateNews flex flex-col gap-7 items-start">
                <div className="flex items-start justify-between w-full">
                    <Breadcrumbs underline="hover">
                        ...
                        <BreadcrumbItem>Tạo giáo viên</BreadcrumbItem>
                    </Breadcrumbs>
                ...
                <Button onClick={Create} color="primary" radius="sm">
                    <span className="font-medium">Tạo giáo viên</span>
                </Button>
            </div>
        </div>
    );
